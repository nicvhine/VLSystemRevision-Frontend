...
interface WithCollateralProps extends ApplicationCardProps {
  isEditing?: boolean;
  collateralData?: any;
  setCollateralData?: any;
}

export default function WithCollateral({ application, isEditing, collateralData, setCollateralData }: WithCollateralProps) {
