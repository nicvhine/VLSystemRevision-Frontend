...
export default function AgreementModal({
  ...
  const monthlyMinPayment = application.appLoanAmount * application.appInterestRate / 100;
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6 flex justify-between items-center rounded-t-xl">
          <div>
            <h2 className="text-2xl font-bold text-white">Open-Term Loan Agreement Confirmation</h2>
        ...
        <div className="px-8 py-6 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div className="bg-red-50 p-4 rounded-lg border border-red-200">
            <p className="text-gray-800 font-semibold mb-3">Open-Term Loan Details:</p>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start">
                <span className="text-red-600 mr-2">•</span>
                <span>Flexible loan with no fixed end date</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-600 mr-2">•</span>
                <span>Diminishing interest calculated monthly on remaining principal</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-600 mr-2">•</span>
                <span>Pay at least {formatCurrency(monthlyMinPayment)} monthly (interest)</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-600 mr-2">•</span>
                <span>Additional principal payments can be made anytime</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start">
                <span className="text-yellow-600 mr-2">✓</span>
                <span>Pay diminishing interest of {application.appInterestRate}% per month on the remaining principal balance</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-600 mr-2">✓</span>
                <span>Pay a minimum of {formatCurrency(monthlyMinPayment)} each month to cover interest</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-600 mr-2">✓</span>
                <span>Pay principal and interest until the loan is fully repaid</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-600 mr-2">✓</span>
